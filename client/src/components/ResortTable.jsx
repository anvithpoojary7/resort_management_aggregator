        ...
        >
          <div className="flex justify-between items-center flex-wrap">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-lg font-semibold text-gray-800">{resort.name}</p>
            ...
            <div className="text-sm text-gray-700 min-w-[120px]">
              <p className="font-medium">{resort.owner}</p>
            ...
            <div className="text-sm text-gray-700 min-w-[120px]">
              ...
              <p className="text-xs text-gray-500">₹{resort.revenue || 0} revenue</p>
            </div>
